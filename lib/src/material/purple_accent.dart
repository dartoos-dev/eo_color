...
class PurpleAccent extends PaletteRGB {
  /// Primary shade #E040FB ≡ Colors.purpleAccent.
  const PurpleAccent() : super.opaque(0xE040FB);

  /// Light shade  #EA80FC ≡ Colors.purpleAccent[100].
  const PurpleAccent.light() : super.opaque(0xEA80FC);

  /// Darker default shade #D500F9 ≡ Colors.purpleAccent[400].
  const PurpleAccent.darker() : super.opaque(0xD500F9);

  /// Dark shade #AA00FF ≡ Colors.purpleAccent[700].
